...
import com.example.yumarketforowners.databinding.OrderListViewPagerFragmentBinding
import com.example.yumarketforowners.screen.base.BaseFragment

class OrderListViewPagerFragment : BaseFragment<OrderListViewPagerFragmentBinding>() {
    companion object {
    ...
    override fun getViewBinding(
        ...
        container: ViewGroup?
    ) = OrderListViewPagerFragmentBinding.inflate(inflater, container, false)
